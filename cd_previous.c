...
/**
* cd_dot - changes back to d parent's direct.
*
* @datash: relevant environment data
*
* Return: no
*/
...
/**
* cd_to - changes to another dir.
* by the user
*
* @datash: relevsnt dir. data
* Return: no
*/
...
/**
* cd_previous - changes to former dir.
*
* @datash: relevant environment data
* Return: no
*/
...
*
* @datash: environment relevant data
* Return: no
*/
